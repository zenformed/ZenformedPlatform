...
export function SettingsIcon({ className }: { className?: string }): React.ReactElement {
  return (
    <svg
      className={className}
      width="20"
...
export function SignOutIcon({ className }: { className?: string }): React.ReactElement {
  return (
    <svg
      className={className}
      width="20"
...
export function ShopIcon({ className }: { className?: string }): React.ReactElement {
  return (
    <svg
      className={className}
      width="20"
...
export function UsersIcon({ className }: { className?: string }): React.ReactElement {
  return (
    <svg
      className={className}
      width="20"
